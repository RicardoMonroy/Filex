    ...
    <body>
        ...
        <div id="login-container">
            ...
            <div id="page-content" class="block remove-margin">
                ...
                <form method="POST" action="{{ route('login') }}" id="form-login" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4 text-right">
                            ...
                            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-angle-right"></i>{{ __('Login') }}</button>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                ...
                <form method="POST" action="{{ route('register') }}" id="form-register" class="form-horizontal display-none">
                    @csrf
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror input-lg" placeholder="Username" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                {{-- <input type="text" id="register-email" name="register-email" class="form-control input-lg" input-lg> --}}
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror input-lg"placeholder="Email" input-lg name="email" value="{{ old('email') }}" required autocomplete="email">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror input-lg" placeholder="Password" name="password" required autocomplete="new-password">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input id="register-password-verify" type="password" class="form-control input-lg" name="password_confirmation" placeholder="Confirmar Password" required autocomplete="new-password">
                            </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-8">
                            <div class="btn-group">
                                {{-- <a href="#modal-terms" class="btn btn-sm btn-primary" data-toggle="modal">Términos</a>
                                <button type="button" class="btn btn-sm btn-default" data-toggle="button" id="btn-terms"><i class="fa fa-check"></i> De acuerdo</button> --}}
                            </div>
                        </div>
                        <div class="col-xs-4 text-right">
                            {{-- <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-angle-right"></i> Register</button> --}}
                            <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-angle-right"></i> {{ __('Registrar') }}</button>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <p class="text-center remove-margin"><small>Ya tienes una cuenta?</small> <a href="javascript:void(0)" id="link-register"><small>Login aquí!</small></a></p>
                        </div>
                    </div>
                </form>
                <!-- END Register Form -->
