                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <div class="col-md-6">
                                    {{-- <a href="{{ route('contracts.recibe', $file->id) }}" data-toggle="tooltip" title="Invitar a firma" class="btn btn-sm btn-default"><i class="fa fa-envelope-open"></i></a> --}}
                                </div>
                                <div class="col-md-6">
                                    <form action="{{ route('files.destroy',$file->id) }}" method="POST">
                                        ...
                                        @method('DELETE')
                                        <button type="submit" data-toggle="tooltip" title="Eliminar" class="btn btn-sm btn-default"><i class="fa fa-times"></i></button>
                                    </form>
                                </div>
